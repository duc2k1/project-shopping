...
function defaultEnumValueConfigMerger(candidates) {
    var preferred = candidates.find(function (_a) {
        ...
        return delegate.isSubschemaConfig(subschema) && ((_c = (_b = subschema.merge) === null || _b === void 0 ? void 0 : _b[type.name]) === null || _c === void 0 ? void 0 : _c.canonical);
    });
...
function defaultTypeCandidateMerger(candidates) {
    var canonical = candidates.filter(function (_a) {
        var _b, _c;
        var type = _a.type, subschema = _a.subschema;
        return delegate.isSubschemaConfig(subschema) ? (_c = (_b = subschema.merge) === null || _b === void 0 ? void 0 : _b[type.name]) === null || _c === void 0 ? void 0 : _c.canonical : false;
    });
...
function canonicalFieldNamesForType(candidates) {
    ...
    candidates.forEach(function (_a) {
        var _b, _c;
        var type = _a.type, subschema = _a.subschema;
        if (delegate.isSubschemaConfig(subschema) && ((_c = (_b = subschema.merge) === null || _b === void 0 ? void 0 : _b[type.name]) === null || _c === void 0 ? void 0 : _c.fields) && !subschema.merge[type.name].canonical) {
