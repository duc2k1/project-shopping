...
import { createStub, createNamedStub, fieldToFieldConfig, inputFieldToFieldConfig, rewireTypes, parseSelectionSet, pruneSchema, filterSchema, getImplementingTypes, mapSchema, MapperKind, getDirectives, mergeDeep, SchemaDirectiveVisitor } from '@graphql-tools/utils/es5';
...
function defaultEnumValueConfigMerger(candidates) {
    var preferred = candidates.find(function (_a) {
        var _b, _c;
        var type = _a.type, subschema = _a.subschema;
        return isSubschemaConfig(subschema) && ((_c = (_b = subschema.merge) === null || _b === void 0 ? void 0 : _b[type.name]) === null || _c === void 0 ? void 0 : _c.canonical);
    });
...
function defaultTypeCandidateMerger(candidates) {
    var canonical = candidates.filter(function (_a) {
        var _b, _c;
        var type = _a.type, subschema = _a.subschema;
        return isSubschemaConfig(subschema) ? (_c = (_b = subschema.merge) === null || _b === void 0 ? void 0 : _b[type.name]) === null || _c === void 0 ? void 0 : _c.canonical : false;
    });
...
function defaultFieldConfigMerger(candidates) {
    ...
    candidates.forEach(function (_a) {
        ...
        var type = _a.type, fieldName = _a.fieldName, fieldConfig = _a.fieldConfig, subschema = _a.subschema;
        if (!isSubschemaConfig(subschema))
            return;
        if ((_e = (_d = (_c = (_b = subschema.merge) === null || _b === void 0 ? void 0 : _b[type.name]) === null || _c === void 0 ? void 0 : _c.fields) === null || _d === void 0 ? void 0 : _d[fieldName]) === null || _e === void 0 ? void 0 : _e.canonical) {
            canonicalByField.push(fieldConfig);
        }
        else if ((_g = (_f = subschema.merge) === null || _f === void 0 ? void 0 : _f[type.name]) === null || _g === void 0 ? void 0 : _g.canonical) {
...
function defaultInputFieldConfigMerger(candidates) {
    ...
    candidates.forEach(function (_a) {
        var _b, _c, _d, _e, _f, _g;
        var type = _a.type, fieldName = _a.fieldName, inputFieldConfig = _a.inputFieldConfig, subschema = _a.subschema;
        if (!isSubschemaConfig(subschema))
            return;
        if ((_e = (_d = (_c = (_b = subschema.merge) === null || _b === void 0 ? void 0 : _b[type.name]) === null || _c === void 0 ? void 0 : _c.fields) === null || _d === void 0 ? void 0 : _d[fieldName]) === null || _e === void 0 ? void 0 : _e.canonical) {
...
function canonicalFieldNamesForType(candidates) {
    ...
    candidates.forEach(function (_a) {
        var _b, _c;
        var type = _a.type, subschema = _a.subschema;
        if (isSubschemaConfig(subschema) && ((_c = (_b = subschema.merge) === null || _b === void 0 ? void 0 : _b[type.name]) === null || _c === void 0 ? void 0 : _c.fields) && !subschema.merge[type.name].canonical) {
            Object.entries(subschema.merge[type.name].fields).forEach(function (_a) {
                    ...
                    if (mergedTypeConfig.computedFields) {
                        ...
                        Object.keys(mergedTypeConfig.computedFields).forEach(function (fieldName) {
                            if (mergedTypeConfig.computedFields[fieldName].selectionSet) {
                                ...
                                parsedFieldSelectionSets_2[fieldName] = parseSelectionSet(rawFieldSelectionSet, { noLocation: true });
                            }
                        });
