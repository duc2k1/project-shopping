...
function defaultEnumValueConfigMerger(candidates) {
    const preferred = candidates.find(({ type, subschema }) => { var _a, _b; return isSubschemaConfig(subschema) && ((_b = (_a = subschema.merge) === null || _a === void 0 ? void 0 : _a[type.name]) === null || _b === void 0 ? void 0 : _b.canonical); });
...
function defaultTypeCandidateMerger(candidates) {
    const canonical = candidates.filter(({ type, subschema }) => { var _a, _b; return isSubschemaConfig(subschema) ? (_b = (_a = subschema.merge) === null || _a === void 0 ? void 0 : _a[type.name]) === null || _b === void 0 ? void 0 : _b.canonical : false; });
...
function canonicalFieldNamesForType(candidates) {
    ...
    candidates.forEach(({ type, subschema }) => {
        var _a, _b;
        if (isSubschemaConfig(subschema) && ((_b = (_a = subschema.merge) === null || _a === void 0 ? void 0 : _a[type.name]) === null || _b === void 0 ? void 0 : _b.fields) && !subschema.merge[type.name].canonical) {
