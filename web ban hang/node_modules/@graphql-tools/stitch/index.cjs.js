...
function defaultEnumValueConfigMerger(candidates) {
    const preferred = candidates.find(({ type, subschema }) => { var _a, _b; return delegate.isSubschemaConfig(subschema) && ((_b = (_a = subschema.merge) === null || _a === void 0 ? void 0 : _a[type.name]) === null || _b === void 0 ? void 0 : _b.canonical); });
...
function defaultTypeCandidateMerger(candidates) {
    const canonical = candidates.filter(({ type, subschema }) => { var _a, _b; return delegate.isSubschemaConfig(subschema) ? (_b = (_a = subschema.merge) === null || _a === void 0 ? void 0 : _a[type.name]) === null || _b === void 0 ? void 0 : _b.canonical : false; });
...
function defaultFieldConfigMerger(candidates) {
    ...
    candidates.forEach(({ type, fieldName, fieldConfig, subschema }) => {
        ...
        if (!delegate.isSubschemaConfig(subschema))
            return;
        if ((_d = (_c = (_b = (_a = subschema.merge) === null || _a === void 0 ? void 0 : _a[type.name]) === null || _b === void 0 ? void 0 : _b.fields) === null || _c === void 0 ? void 0 : _c[fieldName]) === null || _d === void 0 ? void 0 : _d.canonical) {
            canonicalByField.push(fieldConfig);
        }
        else if ((_f = (_e = subschema.merge) === null || _e === void 0 ? void 0 : _e[type.name]) === null || _f === void 0 ? void 0 : _f.canonical) {
...
function canonicalFieldNamesForType(candidates) {
    ...
    candidates.forEach(({ type, subschema }) => {
        var _a, _b;
        if (delegate.isSubschemaConfig(subschema) && ((_b = (_a = subschema.merge) === null || _a === void 0 ? void 0 : _a[type.name]) === null || _b === void 0 ? void 0 : _b.fields) && !subschema.merge[type.name].canonical) {
                    ...
                    if (mergedTypeConfig.fields) {
                        ...
                        Object.keys(mergedTypeConfig.fields).forEach(fieldName => {
                            if (mergedTypeConfig.fields[fieldName].selectionSet) {
                                ...
                                parsedFieldSelectionSets[fieldName] = utils.parseSelectionSet(rawFieldSelectionSet, { noLocation: true });
                            }
                        });
    ...
    return (subschemaConfig) => {
        ...
        utils.mapSchema(subschemaConfig.schema, {
            [utils.MapperKind.OBJECT_FIELD]: (fieldConfig, fieldName, typeName, schema) => {
                ...
                const computed = utils.getDirectives(schema, fieldConfig)[computedDirectiveName];
                if (computed == null) {
                    return undefined;
                }
...
function applySubschemaConfigTransforms(subschemaConfigTransforms, subschemaOrSubschemaConfig, subschemaMap, originalSubschemaMap) {
    ...
    const transformedSubschemas = isolateComputedFields(newSubschemaConfig).map(subschemaConfig => new delegate.Subschema(subschemaConfig));
